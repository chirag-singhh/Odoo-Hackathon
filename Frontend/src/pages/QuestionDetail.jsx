...
//       const res = await API.post(`/answers/${id}`, { description: newAnswer }, {
//         headers: {
...
//     try {
//       const token = localStorage.getItem("token");
//       const res = await API.put(`/answers/${answerId}/vote`, { voteType }, {
//         headers: {
//           Authorization: `Bearer ${token}`
//         }
//       });
...
//         ) : (
//           answers.map((ans) => (
//             <div key={ans._id} className="bg-[#3b2a61] p-4 mb-4 rounded shadow">
